...
This is is exactly the kind of data needed to build word clouds like the following clouds built by [Jason Davies d3-cloud](https://github.com/jasondavies/d3-cloud){target=_blank}:
