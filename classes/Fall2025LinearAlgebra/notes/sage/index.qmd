...
Note that I'm working within an "Edit Code" box within my Discourse forum. I'm not developing on my local machine. There's a specific spot in that code box where I can edit Javascript that looks like so:
...
So, I guess I need to be working with an apiInitializer.
...
I've set up a [10 point problem on our forum](https://discourse.marksmath.org/t/solving-your-personal-system/28){target=_blank} so that everyone can try their hand at this. Give it a try!