...
We have our first exam next Friday, September 18th. The problems on the exam will be very much like the problems you see here. We will practice similar problems in class next Wednesday and it will help you immensely if you think this stuff out prior to that. You've got several resources to get help on this problem sheet, including:

- Our fabulous SI Leader Kris,
- The math lab, and
- Our forum, where I will offer direct help via the link at the bottom of the page.
...
8. Suppose that $f$ and $g$ are differentiable functions. Show that
   $$\frac{d}{dx}(3f(x) - g(x)) = 3f'(x) - g'(x),$$
   *using the definition of the derivative*.

\newpage 

9. Find the derivatives of the following functions using the basic differentiation rules.

   a. $f(x) = 3x^2 + 2x + 1$
   b. $f(x) = 61x^{48} + 2x^{16} + x^{14} - x - 1$
   c. $f(x) = \frac{x^4 - x^3 + 2x^2 - x + 1}{x^2}$.
   d. $f(x) = \frac{x-1}{\sqrt{x}}$.

10. The graph of the function $f$ is shown in the top part of @fig-sketch. Sketch the graph of $f'$ on the axes provided below the graph of $f$.
