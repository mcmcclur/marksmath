...
// Typeset M and MInv for the buttons


// Interactive control for the eigen_pic
export function apply_switch(opts = {}) {
  const { 
    invertible = true,
    matrix_symbol = "M"
 } = opts;
  ...
  let cur_value = value;
  div.append("span").html("Apply: ");
  const M = div.append("button")
  ...
  let MInv = div
    ...
    .style('width', '50px')
    .style('height', '40px')
    .property("disabled", !invertible)
    .html(`${matrix_symbol}Inv`)
    // .html("<img src='/images/MInv.svg'>");
