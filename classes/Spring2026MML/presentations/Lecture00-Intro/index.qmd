...
As a concrete example, we'll start with the now widely used Palmer penguin data set.
...
We'll use this data a few times throughout this semester.
...
To be clear about what we mean by *observational level, tidy data*, let's draw a distinction between it and *summary level data*.
