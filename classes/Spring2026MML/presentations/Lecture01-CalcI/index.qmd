...
The last rule that you typically learn is the *chain rule*, which plays a prominent rule the technique of *gradient descent* when applied to neural networks:
