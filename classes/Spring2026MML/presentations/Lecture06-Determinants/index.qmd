...
The expression $ad-bc$ for the determinant of a $2\times2$ matrix can be defined in useful and consistent way for matrices of any dimension. The technique for doing so is called *cofactor expansion* is defined in a recursive fashion. We'll show how to do so in this column of slides.
...
The next slide shows an example illustrating the effect of the elementary operation $2R_2+R3 \to R3$ to get the 3D elementary matrix
$$
\begin{bmatrix}
  1&0&0 \\
  0&1&0 \\
