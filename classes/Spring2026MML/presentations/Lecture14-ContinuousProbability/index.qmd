...
The validity of the Z-score translation can be proven using the $u$-substitution
$$u = \frac{x-\mu}{\sigma} \text{ so } du = \frac{1}{\sigma} dx.$$
...
$$
\frac{1}{\sqrt{18\pi}} \int_{-1}^4 e^{-(x-1)^2/18} \, dx.
$$
:::
...
\begin{aligned}
\frac{1}{\sqrt{18\pi}} \int_{-1}^4 e^{-(x-1)^2/18} \, dx &= 
\frac{1}{\sqrt{2\pi}} \int_{-1}^4 e^{-\frac{1}{2}\left(\frac{x-1}{3}\right)^2} \, \frac{1}{3}dx \\
= \frac{1}{\sqrt{2\pi}} \int_{-2/3}^1 e^{-u^2/2} \, du.
\end{aligned}
$$
