...
- Wed, Apr 8: Neural Networks
  ...
  - [Colab notebook for classification plots](https://colab.research.google.com/drive/16EY9Mdajo-Pe-bp_MucNBhOruA7PL-TZ?usp=sharing#sandboxMode=true){target=_blank}
<details>
  <summary>Comments</summary>
  <div>
...
- Fri, Apr 10: Practical Networks
  - [Colab notebook](https://colab.research.google.com/drive/1FzwNqBrU10tMk5yYuLen7a1taIRK-_R5?usp=sharing#sandboxMode=true){target=_blank}
  - [Presentation](./Lecture23-PracticalNetworks/){target=_blank} 
<details>
  <summary>Comments</summary>
  <div>
...
- Monday, April 13: Lab 3 on Neural Networks
  - [Lab 3](https://colab.research.google.com/drive/1sas7UOUEYSll8acgZzcJJ4RkCcSYx0zz?usp=sharing#sandboxMode=true){target=_blank}
<details>
  <summary>Comments</summary>
  <div>
    We've got our last lab today on Neural Networks. We should get closer to understanding how image recognition works.
  </div>
</details>

- Mon, Apr 20: Convolution
  - [Presentation](./Lecture24-Convolution/){target=_blank}
<details>
  <summary>Comments</summary>
  <div>
    Recently, we learned how neural networks can be used for image classification. While basic feed forward neural networks can perform OK for this task, the addition of a so-called *convolutional layer* improves performance. Today, we'll learn the mathematics of convolution and then, next time, we'll see how that plays out in the context of Tensorflow.
  </div>
</details>

- Wed, Apr 22: Layer types for Neural Networks
  - [Colab Notebook](https://colab.research.google.com/drive/1WF9GkTbjlwMmH4yS75U7U8pBONYNxV_U?usp=sharing#sandboxMode=true){target=_blank}
<details>
  <summary>Comments</summary>
  <div>

    Today, we'll take a look at how we might think of a neural network as a sequence of layers of various types. Often, these layers could be implemented as dense layers with specific restrictions but it can be much easier conceptually to think of them a bit more abstractly.

    Our most specific objective is to understand how specific kernels (or filters, in this context) arise via model fitting in a convolutional layer.
  </div>
</details>


- Fri, Apr 24: LLMs
  - [Presentation](./Lecture25-LLMs/){target=_blank}
<details>
  <summary>Comments</summary>
  <div>
    Today will be a bit different from usual. While we'll talk a just a little about how some of the mathematics that we've learned fits into the LLM workflow, I'll also point you to some tools you might explore some day and wax slightly philosophic.
  </div>
</details>
