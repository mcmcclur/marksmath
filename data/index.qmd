...
- NCAA Basketball data (multiple files for sports analytics)
  - The Big South 2026 Regular Season 
    - Description: Game by game results of the Mens's 2026 Big South regular season through Feb 10.
    - [CSV](big-south-basketball-games-02.11.26.csv)
...
- Ames housing prices
  - Description: Training data for my variation on [Kaggle's House Prices competition](https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques/){target=_blank}
  - [CSV](./reconstructed_train.csv)
