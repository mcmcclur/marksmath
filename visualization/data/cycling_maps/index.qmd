...
menu_files = ({
  ...
  "MTN: Tsali Left/Right with AD": FileAttachment("./menu_files/TsaliLeftRight.gpx"),
  "MTN: Tsali Thompson/Mouse with AD": FileAttachment("./menu_files/TsaliThompsonMouse.gpx")
});
```
