...
format:
  ...
  pdf: 
    toc: false
    output-file: CompensationAtUNCA
    echo: false
---
...
0. [Task Force on Faculty Salary and Equity](https://drive.google.com/file/d/1W4T64jRPmX6uAsou9K9f0ktizBhU-IIw/view?usp=drive_link){target=_blank} - Jan 2018  
...
1. [Task Force on Total Compensation](https://drive.google.com/file/d/116rwbrxLTb8bJqdNji5lSnAYNxLAULkw/view?usp=drive_link){target=_blank} - May 2019  
    <div class="note-comments">
...
2. [UNCA Salaries and Housing in Asheville](https://drive.google.com/file/d/1MCtSX_TIy-50uICnoeBjNd-aL510HFBZ/view?usp=drive_link){target=_blank} - June 2019  
   <div class="note-comments">
...
3. [Informal report on Faculty Compensation](https://drive.google.com/file/d/1GL8LWyk4u2_JML-D61Ww2utJ0i0pFLe0/view?usp=drive_link){target=_blank} - Feb 2022  
   <div class="note-comments">
...
4. [UNCA Faculty Salaries](https://marksmath.org/writ/UNCAFacultySalariesApr2022.html){target=_blank} - Apr 2022  
   <div class="note-comments">
...
5. [Revitalization Plan](https://drive.google.com/file/d/1rl1Ew5Yj2Jky5fjTLO8RXuSiMTh7LB_y/view?usp=drive_link){target=_blank} - Sep 2022  
   <div class="note-comments">
...
6. [First Compensation Committee report](https://drive.google.com/file/d/1Xw1s8al40-dzUccnilEseeu3_BPtJMFp/view?usp=drive_link){target=_blank} - Feb 2023  
   <div class="note-comments">
...
7. [Slides for committee presentation to Staff Council](https://marksmath.org/presentations/CompensationSlides2023/){target=_blank} - Mar 2023  
   <div class="note-comments">
...
::::: {.content-visible when-format="pdf"}
![](./images/system_salary_bar_chart.png)
:::::
:::
...
:::::
::::: {.content-visible when-format="pdf"}
![](./images/national_salary_compression.png)
:::::
:::
...
![](./images/system_compression_ratios.png)
:::::
:::
...
::::: {.content-visible when-format="pdf"}
![](./images/my_salary_time_series.png)
:::::
:::
