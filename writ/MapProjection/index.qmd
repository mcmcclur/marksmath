...
On Friday, we'll dig deeper into the formulae for these map projections and we'll learn what really makes a map conformal or equal area. One point I hope to impress upon you is 

::: {.callout-note appearance=minimal} 

Mercator's map has often been criticized for its disproportionate representation of areas and, as we've already said, it should *not* be used for choropleth maps. 
